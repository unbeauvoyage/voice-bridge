...
- Name: summarization-pipeline.spec.ts >> GET /prompt-templates/summary returns templates with id and template fields
- Location: tests/summarization-pipeline.spec.ts:116:1
