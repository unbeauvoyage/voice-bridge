...
- Name: raise-web.spec.ts >> clicking raise in the reader opens an inline form with a note textarea
- Location: tests/raise-web.spec.ts:68:1
  ...
  - generic [ref=e44]:
    ...
    - generic [ref=e59]:
      ...
      - link "Open original →" [ref=e61] [cursor=pointer]:
        - /url: https://example.com/raise-web-test-raise-web-1776271538361-xjqow
    - generic [ref=e63]:
